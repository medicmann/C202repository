...
public class BinarySearchTree<E extends Comparable<E>> extends AbstractTree<E> {
  ...
  private java.util.ArrayList<E> inList = new java.util.ArrayList<>();
  ...
  private java.util.ArrayList<E> preList = new java.util.ArrayList<>();
  private boolean mCall2 = false;
  /** Preorder traversal from a subtree */
  protected void preorder(TreeNode<E> root) {
    if (root == null) return;
    if(mCall2 == true) {
        preList.add(root.element);
    } else {
        System.out.print(root.element + " ");
    }
    preorder(root.left);
  ...
  public TreeNode getRoot() {
        ...
        if(search(e) == false) {
            ...
            while (current != null) {
                if (e.compareTo(current.element) < 0) {
                    ...
                    current = current.left; // Element is found
                    mCall2 = true;
                    preorder(current);
                    mCall2 = false;
                }
        ...
        if(search(e) == false) {
            ...
            while (current != null) {
                if (e.compareTo(current.element) < 0) {
                    ...
                    current = current.right; // Element is found
                    mCall2 = true;
                    preorder(current);
                    mCall2 = false;
                }
    ...
    public E inorderPredecessor(E e){
        if(root == null || search(e) == false) {
            ...
            inorder();
            mCall = false;
            return inList.get(inList.indexOf(e) - 1);
        } 
    }
