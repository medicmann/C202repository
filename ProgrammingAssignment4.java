...
public class ProgrammingAssignment4 {
    ...
    //Instantiate and array of 26 Linked Lists
    MyLinkedList[] list = new MyLinkedList[26];
    
    /** 
     * Description: This is a void method that populates the 26 LL's with 
     *              alphabetically based indices where the first letter of
     *              each word has its own linked list.
     */
    public void popDic(){
    ...
    public static void main(String[] args) {
        ProgrammingAssignment4 x = new ProgrammingAssignment4();
        x.popDic();
        x.readOliver();
    }
}
